...
COMMAND_MOVE_A_FWD      = 21    # Move motor A forward by n encoder ticks
COMMAND_MOVE_A_REV      = 22    # Move motor A reverse by n encoder ticks
COMMAND_MOVE_B_FWD      = 23    # Move motor B forward by n encoder ticks
COMMAND_MOVE_B_REV      = 24    # Move motor B reverse by n encoder ticks
